    ...
    <div className="bg-[url('/LastBiteStandingBackground.jpg')] bg-cover bg-center sm:bg-top min-h-screen">
      <div className="absolute inset-0 bg-black/30 backdrop-blur-sm">
        <div className="flex flex-col justify-center min-h-screen items-center">
          <h1 className="text-7xl md:text-8xl lg:text-9xl font-bold text-white text-shadow-lg font-serif">
            CHOODIE
          </h1>
          <p className="text-4xl md:text-5xl lg:text-6xl text-white font-serif text-shadow-lg mt-4 text-center">
            Find the best resturants near you
          </p>
